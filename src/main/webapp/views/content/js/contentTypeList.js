var ContentTypeList = {
	code : "ContentTypeList",
	baseUrl : ctx + "/content/contentType/",
	isAllowDrop : true,
	init:function(){
		var _this=this;
	...
	initActions : function() {
		var _this = this;
		this.actions["ContentTypeList.save"] = function(e, form, holderDiv, btnObj) {
...
YHUI.use("yhFormField yhLayout yhDropDown yhToolbar yhButton yhDialogTip yhSearchBox yhValidate yhStore", function() {
	var view = $.extend(true, DefaultView, ContentTypeList);
	view.start();
});