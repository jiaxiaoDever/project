...
<div class="container">
      <h1>
<a name="jqgrid-的方法" class="anchor" href="#jqgrid-%E7%9A%84%E6%96%B9%E6%B3%95"><span class="octicon octicon-link"></span></a>jqGrid 的方法</h1>


<h2>
<a name="jqgrid-的方法调用" class="anchor" href="#jqgrid-%E7%9A%84%E6%96%B9%E6%B3%95%E8%B0%83%E7%94%A8"><span class="octicon octicon-link"></span></a>jqGrid 的方法调用</h2>

<p>和 jQuery UI 组件的方法一样， jqGrid 的方法调用如下：</p>

<div class="highlight highlight-js"><pre class="brush: js">$("#grid_id").jqGrid("method",parameter1,...parameterN);
</pre></div>

<p>其中，</p>

<ul>
<li><p>method 表示方法名，比如 getGridParam。</p></li>
<li><p>parameter(1~N) 表示传入的参数。</p></li>
</ul><h2>
<a name="方法列表" class="anchor" href="#%E6%96%B9%E6%B3%95%E5%88%97%E8%A1%A8"><span class="octicon octicon-link"></span></a>方法列表</h2>
...
<td>getCol</td>
        ...
        <td>数组或者数值</td>
        <td>
            获取指定列的内容。<br><strong>colName</strong> 是 colModel 中的 name ，用来指定列。 <br><strong>retrunType</strong> 是布尔值，为 false 或者缺省时，返回一个包含列内容的数组。
            ...
            其中 id 是所在行 id ，value 是对应单元格的内容。 <br><strong>op</strong>，可用值 "sum" "avg" "count" ，如果设置，
