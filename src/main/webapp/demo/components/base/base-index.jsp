...
<body>
 ...
 <script type = "text/javascript">
                ...
                initTabs: function( selector ) {
                    this.tabs = $( selector ).eq( 0 ).yhTabs({
                        ...
                        create: function() {
                            ...
                            $( "#tabs-1" ).children("iframe").attr("src","../../manual/component/yhSwitchPanel.jsp");
                        }
                    });
                },                
            ...
            YHUI.use( "yhLayout yhMenu yhTabs yhLoading yhTreemenu yhDialogTip", function() {
                Homepage.layout();
