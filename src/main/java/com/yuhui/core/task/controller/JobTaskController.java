package com.yuhui.core.task.controller;
...
import com.yuhui.core.task.service.JobTaskService;
...
public class JobTaskController {
	// 日志记录器
	private static Logger log = LoggerFactory.getLogger(JobTaskController.class);
	@Autowired
